...
// Filtrar os valores de faturamento maior que zero (sem fins de semana e feriados)
const valoresValidos = faturamentoDiario.filter(dia => dia.valor > 0).map(dia => dia.valor);
...
const formatarReais = valor => valor.toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' });

console.log("Menor valor de faturamento:", formatarReais(menorValor));
console.log("Maior valor de faturamento:", formatarReais(maiorValor));
